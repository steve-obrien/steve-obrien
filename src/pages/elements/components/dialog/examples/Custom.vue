...
<template>
	...
	>
		...
		<input
			class="mt-3 h-10 w-full rounded-full border border-skin-border bg-skin-background px-4 text-sm"
			placeholder="my-project"
		/>
		<template #footer>
			<ElButton variant="secondary" data-close @click="open = false">Cancel</ElButton>
			<ElButton variant="danger" data-close @click="open = false">Delete</ElButton>
		</template>
	</ElDialog>
</template>
